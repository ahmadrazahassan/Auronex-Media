      ...
      <div className="rounded-[26px] border border-white/80 bg-[#F3EFE8] p-6 shadow-[0_10px_24px_rgba(13,22,25,0.04),inset_0_1px_0_rgba(255,255,255,0.82)]">
        ...
        <div className="flex flex-col gap-4">
          {articles.map((article) => (
            <div key={article.id} className="flex justify-between items-start rounded-2xl border border-white/80 bg-white/75 px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.85)]">
              <div>
              ...
              <span className="text-xs bg-[#F6F9FF] text-[#037aff] px-2.5 py-1 rounded-full font-medium whitespace-nowrap border border-[#DDEAFE]">
      ...
      <div className="rounded-[26px] border border-white/80 bg-[#F3EFE8] p-6 shadow-[0_10px_24px_rgba(13,22,25,0.04),inset_0_1px_0_rgba(255,255,255,0.82)]">
        ...
        <div className="flex flex-col gap-4">
          {subscribers.map((subscriber) => (
            <div key={subscriber.id} className="flex justify-between items-center rounded-2xl border border-white/80 bg-white/75 px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.85)]">
