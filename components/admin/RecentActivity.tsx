      ...
      {type === "articles" ? (
        <div className="flex flex-col gap-4">
          {articles.map((article) => (
            <div key={article.id} className="flex justify-between items-start border-b border-[#E2DFD8]/50 last:border-0 pb-4 last:pb-0">
              <div>
              ...
              <span className="text-xs bg-[#EBF4FF] text-[#037aff] px-2 py-1 rounded-md font-medium whitespace-nowrap">
        ...
        <div className="flex flex-col gap-4">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="flex justify-between items-center border-b border-[#E2DFD8]/50 last:border-0 pb-4 last:pb-0">
