...
export function AdminLoginForm() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F2EC] p-4 sm:p-6 lg:p-8">
      <div className="mx-auto grid min-h-[calc(100vh-2rem)] max-w-6xl overflow-hidden rounded-[28px] border border-[#E2DFD8] bg-white shadow-sm lg:grid-cols-[1.05fr_0.95fr]">
        <section className="flex flex-col justify-between bg-[#F0EFEB] p-8 sm:p-10 lg:p-12">
          <div>
            <div className="inline-flex items-center gap-3 rounded-full border border-[#D9D4CB] bg-white px-4 py-2 text-[#0d1619]">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-[#D9D4CB] bg-white p-5">
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="h-12 rounded-2xl border border-[#D9D4CB] bg-white px-4 text-sm text-[#0d1619] outline-none transition-all placeholder:text-[#A0A8B0] focus:border-[#037aff] focus:ring-4 focus:ring-[#037aff]/10"
              ...
              <Button type="submit" disabled={loading} className="mt-1 h-12 w-full rounded-2xl bg-[#037aff] text-white hover:bg-[#0260CC]">
